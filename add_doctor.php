                                                ...
                                                <div class="tab-content">
                                                    <div class="tab-pane active" id="tab1">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-5">
                                                                <input type="text" class="form-control input-height" placeholder="enter your name" name="doctorname" />
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
			                                                ...
			                                                <div class="col-md-5">
			                                                    <div class="input-group date form_date " data-date="" data-date-format="dd MM yyyy" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
					                                                <input class="form-control input-height" name="dateofbirth" placeholder="date of birth" size="16" type="text" value="">
			                                            ...
			                                            <div class="form-group">
                                                            ...
                                                            <div class="col-md-5">
                                                                <input type="text" class="form-control input-height" placeholder="speciality" name="speciality" />
                                                            </div>
                                                        </div>
                                        				<div class="form-group">
			                                                ...
			                                                <div class="col-md-5">
			                                                    <input name="phone" type="text" class="form-control input-height" placeholder="phone" /> </div>
			                                            </div>
			                                            <div class="form-group">
                                                            ...
                                                            <div class="col-md-5">
                                                                <input type="text" class="form-control input-height" placeholder="enter your email" name="email" />
                                                            </div>
                                                        </div>
			                                            <div class="form-group">
			                                                ...
			                                                <div class="col-md-5">
			                                                    <textarea name="address"  class="form-control-textarea" placeholder=" address" rows="5" ></textarea>
			                                                </div>
			                                            </div>
                                                        <div class="form-group">
                                                    ...
                                                    <div class="tab-pane" id="tab2">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-5">
                                                                <input type="text" class="form-control input-height" placeholder="user name" name="username" />
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-5">
                                                                <input type="password" class="form-control input-height" placeholder="password" name="password" id="submit_form_password" />
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                    ...
                                                    <div class="tab-pane" id="tab3">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-5">
                                                                <input type="text" class="form-control input-height" placeholder="facebook" name="fb" />
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-5">
                                                                <input type="text" class="form-control input-height" placeholder="twitter" name="twitter" />
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-5">
                                                                <input type="text" class="form-control input-height" placeholder="google plus" name="gplus" />
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-5">
                                                                <input type="text" class="form-control input-height" placeholder="linkedin" name="linkedin" />
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-5">
                                                                <input type="text" class="form-control input-height" placeholder="instagram" name="insta" />
                                                            </div>
                                                        </div>
                                                    </div>
