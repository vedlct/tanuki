                                                                                    ...
                                                                                    <td valign="middle" style='vertical-align: middle;'>
                                                                                        <div class='contentEditableContainer contentTextEditable'>
                                                                                            <div class='contentEditable' style='text-align: left;font-weight: light; color:#555555;font-size:26;line-height: 39px;font-family: Helvetica Neue;'>
                                                                                                <h1 class='big'><a target='_blank' href="[CLIENTS.WEBSITE]" style='color:red'>Tanuki</a></h1>
                                                                                            </div>
                                                                                        </div>
                                                                                    </td>
                                                                                </tr>
                                                ...
                                                <div class="movableContent" style="border: 1px; padding-top: 0px; position: relative;">
                                                                                ...
                                                                                <table width="100%">
                                                                                    <tr>
                                                                                        <td style="width: 40%; text-align: center;">
                                                                                            ...
                                                                                            <p style="color: red;">Order Number# <br> <?php echo $allOrder->id ?></p>
                                                                                            <p style="color: #4C4C4C; margin: 0 auto;">Date Ordered: <br> <?php echo $allOrder->orderDate?></p>
                                                                                            <p style="color: red; margin: 0 auto;">Delivery In: <br><?php echo date('H:i', mktime(0,$allOrder->deliveryTime));?></p>
                                                    ...
                                                    <table  width="100%" border="0" cellspacing="0" cellpadding="0" align="center"  style="width: 100%; color: #000017; text-align: center; border: 1px" class="table table-bordered">
                                                        ...
                                                        <?php $total=0;$i=1;foreach ($ordersItems as $orderItems){?>
                                                            ...
                                                            <tr>
                                                                <td><?php echo $i?></td>
                                                                <td><?php echo $orderItems->itemName?><br><?php echo $orderItems->description?></td>
                                                                <td><?php echo $orderItems->itemSize?></td>
                                                                <td>$<?php echo $orderItems->rate?></td>

                                                                <td><?php echo $orderItems->quantity?></td>
                                                                <?php if (!empty($orderItems->discount)){?>
                                                                    <td>$<?php echo $discount=$orderItems->discount?></td>
                                                                <?php }else{?>
                                                                    <td>$<?php echo $discount=$orderItems->discount?></td>
                                                                <?php }?>
                                                                <td>$<?php echo $price=(($orderItems->rate * $orderItems->quantity)-$discount) ?></td>
                                                            </tr>
