...
<!--                                            </td>-->
                                            ...
                                            <td>
                                                <a href="<?php echo  base_url()?>Pdf/PdfMaker/OrderBillPdf/<?php echo $orders->id?>" target="_blank">
                                                ...
                                                <a href="<?php echo  base_url()?>Waiter/Orders/cancelOrder/<?php echo $orders->id?>" onclick="return confirm('Are you sure To Cancel This Order?')">
...
<script>
    ...
    function editOrderItemsId(x)
    {
        ...
        $.ajax({
            type:'POST',
            url:'<?php echo base_url("Waiter/Orders/editOrderItems" )?>',
            data:{id:btn},
            cache: false,
    ...
    function deleteOrderItemsId(x)
    {
        if (confirm("are you sure to delete this Category?"))
        {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url("Waiter/Orders/deleteOrderedItemsId")?>',
                data: {id: btn},
                cache: false,
                success: function (data) {
    ...
    function addNewItemOrder(x)
    {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url("Waiter/Orders/NewOrderItems")?>',
                data: {id: btn},
                cache: false,
                success: function (data) {
                    $('#txtHint').html(data);
    ...
    function orderInformation(x)
    {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url("Waiter/Orders/orderInfo")?>',
            data: {id: btn},
            cache: false,
            success: function (data) {
                $('#txtHint').html(data);
    ...
    function showItemByCategory(x)
    {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url("Waiter/Orders/getAllItemsByCategory")?>',
            data: {id: catId},
            cache: false,
            success: function (data) {
    ...
    function showItemSizesByItem(x)
    {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url("Waiter/Orders/getAllItemSizesByItem")?>',
            data: {id: itemId},
            cache: false,
            success: function (data) {
    ...
    function discount() {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url("Waiter/Orders/setDiscount")?>',
    ...
    function showItemPriceByItemSizeId(x)
    {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url("Waiter/Orders/getItemPriceByItemSize")?>',
            data: {id: itemSizeId },
            cache: false,
            success: function (data) {
...
//    }
    ...
    function deliveryTime(x)
    {
        ...
        $.ajax({
            type:'POST',
            url:'<?php echo base_url("Waiter/Orders/addDeliveryTime" )?>',
    ...
    function searchByOrderId()
    {
        ...
        $.ajax({
            type:'POST',
            url:'<?php echo base_url("Waiter/Orders/searchByOrderId" )?>',
    ...
    function changeStatus(v) {
        ...
        if (confirm("are you sure to Change this Oder Status?")) {
           ...
           // alert(orderId);
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url("Waiter/Orders/changeOrderStatus/")?>' + orderId,
                data: {status: option},
                cache: false,
                success: function (data) {
