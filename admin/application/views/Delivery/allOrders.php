...
<script>
    ...
    function orderInformation(x)
    {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url("Delivery/Orders/orderInfo")?>',
            data: {id: btn},
            cache: false,
            success: function (data) {
                $('#txtHint').html(data);
    ...
    function searchByOrderId()
    {
        ...
        $.ajax({
            type:'POST',
            url:'<?php echo base_url("Delivery/Orders/searchByOrderId" )?>',
    ...
    function changeStatus(v) {
        ...
        if (confirm("are you sure to Change this Oder Status?")) {
           ...
           // alert(orderId);
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url("Delivery/Orders/changeOrderStatus/")?>' + orderId,
                data: {status: option},
                cache: false,
                success: function (data) {
