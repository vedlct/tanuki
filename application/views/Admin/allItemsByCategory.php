        ...
        <tr class="odd gradeX">
            ...
            <td class="center">
                ...
                <tr>
                    ...
                    <td width="20%"><button  class="btn btn-primary btn-xs"  data-panel-id="<?php echo $res->itemSizeId ?>" onclick="selectid2(this)">

                            <i class="fa fa-edit"></i>
                        </button>

                        <button type="button" data-panel-id="<?php echo $res->itemSizeId ?>" onclick="selectid3(this)"class="btn btn-danger btn-xs">
