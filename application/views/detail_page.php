...
<!--                            <span class="form-control" style="text-align: center; border-right:none; border-left:none; border-radius:0px; width: 20px; padding:6px 2px; height:auto; name="qty" id="--><?php //echo $c['rowid']?><!--">--><?php //echo $c['qty']?><!--</span>-->
