...
<!--    <link href="--><?php //echo base_url()?><!--public/css/modal.css" rel="stylesheet">-->
    ...
    <style media="all">
         /*modal css minify  (original file in modal.css)*/
        .modal1{display:none;position:fixed;z-index:9999;padding-top:20px;left:-10px;top:0;width:100%;height:100%;overflow:auto;background-color:#000;background-color:rgba(0,0,0,.4)}.modal1-content{background-color:#fefefe;margin:auto;padding:20px;border:1px solid #888;width:40%;border-radius:5px;box-shadow:0 5px 15px rgba(0,0,0,.5)}.close{color:#aaa;float:right;font-size:28px;font-weight:700}.close:focus,.close:hover{color:#000;text-decoration:none;cursor:pointer}
    </style>
